...
export default function Header({ type, session }: { type?: string, session?: SessionData }) {
    ...
    return (
        <Fragment>
            ...
            {open && (
                <div
                    className="fixed inset-0 z-[999] flex items-center justify-end bg-black bg-opacity-50 w-full"
                    role="dialog">
                    <AnimatePresence>
                        <motion.div
                            ...
                            <motion.div
                                ...
                                <div
                                    className="bg-white rounded-lg w-[350px] min-h-[250px] flex flex-col items-center justify-center"
